...
sum(dni)
```
$$dni^2 = (5,4,2,0,1,5,6,7)^2 = (25, 16,  4,  0,  1, 25, 36, 49)$$
$$\sqrt{dni} = \sqrt{(5,4,2,0,1,5,6,7)} = (2.236068, 2.000000, 1.414214, 0.000000, 1.000000, 2.236068, 2.449490, 2.645751) $$
$$\sum_{i=1}^{8} dni= 30 $$


## Pregunta 3

Considerad el vector de las letras de vuestro nombre y apellido. Llamadlo `name`. Por ejemplo, en mi caso sería $$nombre = (P,A,U,L,I,N,A,L,U,N,A)$$.
...
```{r echo=TRUE, eval=TRUE}
nombre = c("P","A","U","L","I","N","A","L","U","N","A")
nom = nombre[1:7]
nom
ape = nombre[8:length(nombre)]
ape
sort(ape)
matrix(ape)
```
$$nombre =("P","A","U","L","I","N","A","L","U","N","A")$$
$$nom= ("P", "A", "U", "L", "I", "N", "A")$$
$$ape =("L", "U", "N", "A")$$
$$("A", "L", "N", "U")$$
$$Matriz = \begin{pmatrix}"L"\\ "U"\\ "N"\\ "A"\end{pmatrix}$$$
