...
<!--No es lo mismo, i aplico primero sort y luego rev me devuelve el vector ordenado en forma descendente, en cambio si primero aplico rev y luego sort lo obtengo en forma ascendente -->
